...
class OrbitsPDSClient {
  ...
  async updateOrbit(uri, name = null, description = null, feeds = null) {
    ...
    return this.request('POST', 'org.chaoticharmonylabs.orbit.update', null, data);
  }
...
async function runTests() {
  ...
  try {
    ...
    console.log('2. Testing orbit creation...');
    ...
    console.log('3. Testing orbit retrieval...');
    ...
    console.log('Your custom AT Protocol lexicons are working correctly.');

  } catch (error) {
    console.error('\n❌ Test failed:', error.message);
    console.log('\nTroubleshooting:');
    console.log('1. Make sure the PDS server is running: npm run dev');
    console.log('2. Check that all lexicon files are properly formatted');
